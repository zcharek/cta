...
const legalTimeline = [
  {
    ...
    detail: (
      <>
        <p className="mb-2">Central Test Agency, société algérienne spécialisée en tests logiciels et automatisation QA.</p>
  ...
  >
    ...
    <div className="flex-1 md:flex md:items-center md:gap-8">
      <div className="md:w-56 mb-2 md:mb-0">
        ...
        <p className="text-brand-blue-900 text-sm italic">{summary}</p>
      </div>
...
const Legal = () => {
  ...
  useEffect(() => {
          document.title = "Mentions Légales & Confidentialité | Central Test Agency";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
              metaDescription.setAttribute('content', "Mentions légales, conditions d'utilisation et politique de confidentialité de Central Test Agency. Conformes à la réglementation algérienne sur la protection des données.");
    }
  }, []);
                  ...
                  <div key={section.id}>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-brand-blue-900 text-sm italic">{section.summary}</p>
                      </div>
