            ...
            <div className="sticky top-2 z-10 bg-white/95 pt-3 pb-6 mb-12 rounded-3xl border border-blue-100 shadow-2xl flex flex-col gap-2 px-4">
              <div className="relative mb-6">
                <input
                  ...
                  className="w-full rounded-full border border-gray-200 px-6 py-4 pr-14 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 bg-white text-gray-800 placeholder-gray-400 shadow transition"
                  style={{ fontSize: '1.1rem' }}
                />
                <span className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 text-2xl pointer-events-none transition-all duration-200 group-hover:text-blue-600">
            ...
            {filteredFaqs.length === 0 && (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
