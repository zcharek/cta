...
const Playwright = () => {
  ...
  const ctaFeatures = [
    {
      icon: "🎭",
      title: "Tests E2E modernes",
      description: "Framework nouvelle génération"
    },
    {
      icon: "🚀", 
      title: "Performance optimale",
      description: "Exécution parallèle native"
    },
    {
      icon: "🔧",
      title: "Configuration simple", 
      description: "Setup rapide et maintenance facile"
    }
  ];
  ...
  return (
    <ServiceLayout seo={seoConfig}>
      <ServiceHero
        ...
        titleGradientFrom="from-purple-200"
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: "Browser Contexts", desc: "Isolation complète entre les tests pour éviter les interférences.", color: "bg-purple-500" },
                  { title: "Auto-waiting", desc: "Attente intelligente des éléments sans timeouts manuels.", color: "bg-indigo-500" },
                  { title: "Trace Viewer", desc: "Debugging visuel avec timeline interactive des actions.", color: "bg-cyan-500" }
                ].map((component, index) => (
