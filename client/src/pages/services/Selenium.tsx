            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                <div className="group cursor-pointer flex flex-col h-full">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white hover:scale-105 transition-transform duration-300 flex-1 flex flex-col">
                    <div className="text-3xl mb-4"></div>
                    <h3 className="text-lg font-bold mb-2">Développement</h3>
                    <p className="text-blue-100 text-sm">Scripts et Page Objects</p>
                  </div>
                  <div className="mt-4 bg-blue-50 rounded-xl p-4">
                    <h4 className="font-semibold text-blue-900 mb-2 text-sm">Langages</h4>
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Java</span>
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white hover:scale-105 transition-transform duration-300 flex-1 flex flex-col">
                    ...
                    <p className="text-blue-100 text-sm">WebDriver local</p>
                  </div>
                  <div className="mt-4 bg-blue-50 rounded-xl p-4">
                    <h4 className="font-semibold text-blue-900 mb-2 text-sm">Navigateurs</h4>
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Chrome</span>
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Firefox</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  ...
                  <div className="mt-4 bg-blue-50 rounded-xl p-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Hub</span>
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Nodes</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white hover:scale-105 transition-transform duration-300 flex-1 flex flex-col">
                    ...
                    <p className="text-blue-100 text-sm">Analyses & Métriques</p>
                  </div>
                  <div className="mt-4 bg-blue-50 rounded-xl p-4">
                    <h4 className="font-semibold text-blue-900 mb-2 text-sm">Outils</h4>
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">Allure</span>
                      <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">ExtentReports</span>
                    </div>
                  </div>
                </div>
              </div>
