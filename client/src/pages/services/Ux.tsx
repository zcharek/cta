  ...
  const ctaFeatures = [
    {
      ...
      description: "Évaluation avec de vrais utilisateurs"
    },
    {
      icon: "🎨", 
      title: "Expertise UX",
      description: "Analyse par des experts certifiés"
    },
    {
      icon: "📊",
      title: "Recommandations", 
      description: "Plan d'amélioration détaillé"
    }
  ];
  ...
  return (
    <ServiceLayout seo={seoConfig}>
      <ServiceHero
        ...
        titleGradientFrom="from-pink-200"
        titleGradientTo="to-indigo-100"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { title: "Facilité d'utilisation", desc: "Vérifier que les utilisateurs peuvent accomplir leurs tâches facilement.", color: "bg-pink-500" },
                  { title: "Navigation intuitive", desc: "S'assurer que la navigation est logique et prévisible.", color: "bg-purple-500" },
                  { title: "Satisfaction utilisateur", desc: "Mesurer le niveau de satisfaction et d'engagement.", color: "bg-indigo-500" }
                ].map((item, index) => (
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { name: "Playwright", icon: "🎭", color: "from-green-500 to-green-600", desc: "Tests automatisés d'interface et d'accessibilité.", link: "/services/playwright", badge: "Parfait pour UI →", badgeColor: "text-green-600" },
            { name: "Cypress", icon: "🌲", color: "from-teal-500 to-teal-600", desc: "Tests visuels avec interface développeur intuitive.", link: "/services/cypress", badge: "Excellent pour debugging →", badgeColor: "text-teal-600" },
            { name: "Percy", icon: "👁️", color: "from-purple-500 to-purple-600", desc: "Tests de régression visuelle automatisés.", link: "/services/percy", badge: "Idéal pour visuel →", badgeColor: "text-purple-600" }
          ].map((tool, index) => (
          ...
          <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 border-2 border-dashed border-pink-300">
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-4">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-pink-50 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { title: "Analyse heuristique", desc: "Évaluation par nos experts UX selon les principes d'utilisabilité.", color: "bg-pink-500" },
                  { title: "Tests utilisateurs", desc: "Sessions avec de vrais utilisateurs pour observer les comportements.", color: "bg-purple-500" },
                  { title: "Tests automatisés", desc: "Validation technique de l'accessibilité et de la performance.", color: "bg-indigo-500" },
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="mt-6 p-4 bg-pink-50 rounded-lg">
                <h4 className="font-semibold text-pink-900 mb-2">🎯 Critères d'évaluation</h4>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {['Clarté interface', 'Logique navigation', 'Feedback utilisateur', 'Cohérence design'].map((criteria, index) => (
                    <div key={index} className="text-pink-700">• {criteria}</div>
                  ))}
                </div>
              </div>
            </div>
      ...
      <ServiceCTA
        ...
        primaryButton={{
          text: "Discuter de votre UX",
          href: "/#contact",
          icon: "💬",
          gradientFrom: "from-pink-500",
          gradientTo: "to-purple-500",
          hoverFrom: "from-pink-600",
