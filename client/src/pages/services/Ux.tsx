    ...
    <ServiceLayout seo={seoConfig}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { title: "Facilité d'utilisation", desc: "Vérifier que les utilisateurs peuvent accomplir leurs tâches facilement.", color: "bg-brand-blue-600" },
                  { title: "Navigation intuitive", desc: "S'assurer que la navigation est logique et prévisible.", color: "bg-brand-blue-600" },
                  { title: "Satisfaction utilisateur", desc: "Mesurer le niveau de satisfaction et d'engagement.", color: "bg-brand-blue-600" }
                ].map((item, index) => (
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { name: "Playwright", icon: "https://upload.wikimedia.org/wikipedia/commons/7/75/Playwright_Logo.svg", color: "from-brand-blue-600 to-brand-blue-900", desc: "Tests automatisés d'interface et d'accessibilité.", link: "/#/services/playwright", badge: "Parfait pour UI →", badgeColor: "text-brand-blue-900" },
            { name: "Cypress", icon: "https://www.cypress.io/cypress_logo_social.png", color: "from-brand-blue-600 to-brand-blue-900", desc: "Tests visuels avec interface développeur intuitive.", link: "/#/services/cypress", badge: "Excellent pour debugging →", badgeColor: "text-brand-blue-900" },
            { name: "Percy", icon: "https://images.opencollective.com/percy_io/80d9595/logo/256.png", color: "from-brand-blue-600 to-brand-blue-900", desc: "Tests de régression visuelle automatisés.", link: "/#/services/percy", badge: "Idéal pour visuel →", badgeColor: "text-brand-blue-900" }
          ].map((tool, index) => (
        ...
        <div className="bg-gradient-to-br from-gray-50 to-brand-blue-50 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { title: "Analyse heuristique", desc: "Évaluation par nos experts UX selon les principes d'utilisabilité.", color: "bg-brand-blue-600" },
                  { title: "Tests utilisateurs", desc: "Sessions avec de vrais utilisateurs pour observer les comportements.", color: "bg-brand-blue-600" },
                  { title: "Tests automatisés", desc: "Validation technique de l'accessibilité et de la performance.", color: "bg-brand-blue-600" },
                  { title: "Recommandations", desc: "Rapport détaillé avec recommandations d'amélioration.", color: "bg-brand-blue-600" }
                ].map((step, index) => (
                  <div key={index} className="flex items-start">
