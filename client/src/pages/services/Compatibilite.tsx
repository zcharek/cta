...
const Compatibilite = () => {
  return (
    <>
      <SEOHead 
        title="Tests de Compatibilité - Central Test Agency"
        ...
        keywords="tests compatibilité, multi-navigateurs, multi-plateformes, Central Test Agency"
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl">
                  ...
                  <div className="mt-6 p-4 bg-brand-blue-50 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div className="text-brand-blue-900">• Rendu visuel</div>
                      <div className="text-brand-blue-900">• Fonctionnalités</div>
                      <div className="text-brand-blue-900">• Performance</div>
                      <div className="text-brand-blue-900">• Responsive design</div>
                    </div>
                  </div>
                </div>
              </div>
