            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="group cursor-pointer flex flex-col h-full">
                  <div 
                    className="backdrop-blur-md rounded-2xl p-6 text-white hover:shadow-3xl hover:scale-105 transition-all duration-300 cursor-pointer flex-1 flex flex-col"
                    onMouseEnter={() => setHoveredCard('planning')}
                    onMouseLeave={() => setHoveredCard(null)}
                    onTouchStart={() => setHoveredCard('planning')}
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  <div 
                    ...
                    onMouseLeave={() => setHoveredCard(null)}
                    onTouchStart={() => setHoveredCard('daily')}
                    onTouchEnd={() => setHoveredCard(null)}
                    style={{
                  ...
                  >
                    ...
                    <p className="text-green-100 text-sm">Synchronisation quotidienne, identification des obstacles, ajustement du plan d'action.</p>
                  </div>
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  <div 
                    ...
                    onMouseLeave={() => setHoveredCard(null)}
                    onTouchStart={() => setHoveredCard('review')}
                    onTouchEnd={() => setHoveredCard(null)}
                    style={{
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  <div 
                    className="backdrop-blur-md rounded-2xl p-6 text-white hover:shadow-3xl hover:scale-105 transition-all duration-300 cursor-pointer flex-1 flex flex-col"
                    onMouseEnter={() => setHoveredCard('retro')}
                    onMouseLeave={() => setHoveredCard(null)}
                    onTouchStart={() => setHoveredCard('retro')}
                    onTouchEnd={() => setHoveredCard(null)}
                    style={{
