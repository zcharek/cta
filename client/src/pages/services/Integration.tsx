...
const Integration = () => {
  return (
    <>
      <SEOHead 
        title="Tests d'Intégration - Outils spécialisés - Central Test Agency"
        description="Découvrez nos outils spécialisés pour les tests d'intégration : Postman, RestAssured, Playwright et plus encore."
        keywords="tests d'intégration, API testing, Postman, RestAssured, Central Test Agency"
      ...
      <main>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-brand-blue-900 via-brand-blue-600 to-rose-400 rounded-3xl p-8 md:p-12 mb-16">
