...
const AboutSection = () => {
  return (
    <PatternBackground 
      className="py-20 md:py-24 bg-gradient-to-b from-white via-gray-50 to-gray-200"
      variant="light"
      opacity={0.15}
      blendMode="multiply"
    >
    <section id="about">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-blue-900 mb-8">
              Notre ADN
            </h2>
          ...
          >
            <div className="grid grid-cols-1 gap-8 max-w-md w-full">
              <div className="bg-white/90 border border-brand-blue-100 rounded-2xl shadow-lg hover:shadow-brand-blue-200 transition-all duration-300 p-8 relative">
                <span className="absolute -top-4 left-6 bg-gradient-to-tr from-brand-blue-700 to-brand-blue-600 text-white text-sm font-bold px-4 py-2 rounded-full shadow">Mission</span>
                <h4 className="font-bold text-brand-blue-900 mb-4 mt-2 text-lg"></h4>
              ...
              <div className="bg-white/90 border border-brand-blue-100 rounded-2xl shadow-lg hover:shadow-brand-blue-200 transition-all duration-300 p-8 relative">
                <span className="absolute -top-4 left-6 bg-gradient-to-tr from-brand-blue-700 to-brand-blue-600 text-white text-sm font-bold px-4 py-2 rounded-full shadow">Vision</span>
                <h4 className="font-bold text-brand-blue-900 mb-4 mt-2 text-lg"></h4>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center mt-8">
              ...
              />
              <span className="inline-block bg-gradient-to-tr from-brand-blue-700 to-brand-blue-600 text-white text-sm font-bold px-4 py-2 rounded-full shadow">Certifié ISTQB</span>
            </div>
          </m.div>
        </div>
      </div>
