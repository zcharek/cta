  ...
  const contactInfo = [
    {
      ...
      title: "Nos bureaux",
      content: "384 lot Guessace Draria, Alger",
    },
    {
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-6 items-start">
          ...
          <m.div
            ...
            className="pr-0 lg:pr-8 mb-8 lg:mb-0"
          >
            <div className="text-2xl font-poppins font-semibold mb-3">
              Central<span className="text-blue-400">TestAgency</span>
            </div>
          ...
          <div className="px-0 lg:px-8 mb-8 lg:mb-0 flex flex-col h-full">
            ...
            <div className="space-y-4">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start">
                  <div className="w-8 h-8 flex items-center justify-center text-white mr-3">
          ...
          <div className="flex flex-col items-center pt-2 lg:pt-0">
            <h4 className="text-lg font-semibold mb-2 text-white">Nos horaires de travail</h4>
            <div className="inline-flex items-center gap-1.5 bg-gradient-to-r from-blue-700 via-blue-500 to-blue-400 text-white text-sm font-semibold rounded-2xl px-4 py-1.5 shadow-md border border-blue-300/30">
              <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4 text-white' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'><path strokeLinecap='round' strokeLinejoin='round' d='M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z' /></svg>
