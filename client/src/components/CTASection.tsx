            ...
            <div className="text-center space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <button
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-brand-blue-700 text-white font-semibold rounded-xl hover:bg-brand-blue-800 focus:outline-none focus:ring-2 focus:ring-brand-blue-600 focus:ring-offset-2 focus:ring-offset-primary transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-trangray-y-1 text-sm sm:text-base"
                >
